...
export default function Projects() {
    ...
    const projects = [
        ...
        {
            title: "FlyContent",
            subtitle: "AI Agent dla content creatorów",
            image: "/images/project_3.webp",
            logo: "/vectors/client_logo_5.svg",
            logoWidth: 120,
            logoHeight: 40,
            link: "/projects/flycontent",
        },
        {
            title: "NetBase",
            subtitle: "Aplikacja mobilna do zarządzania kontaktami networkingowymi",
            image: "/images/project_4.webp",
            logo: "/vectors/client_logo_3.svg",
            logoWidth: 120,
            logoHeight: 40,
            link: "/projects/netbase",
        },
    ];
