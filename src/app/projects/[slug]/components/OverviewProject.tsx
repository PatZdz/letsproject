    ...
    <section className="w-full max-w-[1200px] mx-auto px-4 md:px-0">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="md:col-span-2">
          <h2 className="text-[24px] md:text-3xl font-black mb-6 text-center md:text-left">Project Overview</h2>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-[var(--background-secondary)] p-6 rounded-lg">
            <h3 className="font-semibold text-gray-600 mb-4">Project Scope</h3>
