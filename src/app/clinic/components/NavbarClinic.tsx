      ...
      <div className="w-full max-w-[1200px] mx-auto px-4 md:px-[22px] py-4 bg-[#1D1E22] shadow-md rounded-lg relative z-[41]">
        <nav className="flex items-center relative">
          <div className="flex items-center">
            ...
            >
              <Image
                src={isHovered ? "/vectors/letsproject_logo_clinic_h.svg" : "/vectors/letsproject_logo_beige.svg"}
          ...
          <ul className="hidden md:flex gap-6 items-center absolute left-1/2 transform -translate-x-1/2">
            <li>
              <Link href="/clinic#demo" className="text-[12px] font-semibold text-[#F6F4F1] hover:text-[#3498DB]">
                REALIZACJE
              </Link>
            </li>
            <li>
              <Link href="/clinic#services" className="text-[12px] font-semibold text-[#F6F4F1] hover:text-[#3498DB]">
                USŁUGI
              </Link>
            </li>
            <li>
              <Link href="/clinic#pricing" className="text-[12px] font-semibold text-[#F6F4F1] hover:text-[#3498DB]">
                CENNIK
              </Link>
            </li>
            <li>
              <Link href="/clinic#authority" className="text-[12px] font-semibold text-[#F6F4F1] hover:text-[#3498DB]">
                O MNIE
              </Link>
            </li>
            <li>
              <Link href="/clinic#contact" className="text-[12px] font-semibold text-[#F6F4F1] hover:text-[#3498DB]">
                KONTAKT
              </Link>
            </li>
          </ul>
          <div className="hidden md:flex items-center ml-auto">
            <Link href="/clinic#contact" className="btn-primary">
              KONTAKT
            </Link>
          </div>
